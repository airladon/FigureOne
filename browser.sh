...
then
  docker run -it --rm --ipc=host \
    ...
    -v $LOCAL_PROJECT_PATH/containers/playwright/playwright.config.js:/home/pwuser/playwright.config.js \
    playwright /bin/bash
else
  docker run -i --rm --ipc=host \
    ...
    -v $LOCAL_PROJECT_PATH/package:/home/pwuser/package \
    -v $LOCAL_PROJECT_PATH/containers/playwright/playwright.config.js:/home/pwuser/playwright.config.js \
    playwright /bin/bash -c "npm run http-server-quiet; npx playwright test $1 $2 $3 $4 $5 $6"
fi
