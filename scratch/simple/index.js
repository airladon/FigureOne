...
b = figure.add({
  ...
  text: 'QwertfMy 123\u03C0',
  // text: 'asdf',
  font: { size: 0.5, style: 'italic', family: 'Times new roman', underline: false, weight: '300' },
  color: [1, 0, 0, 1],
  move: { type: 'rotation' },
  yAlign: 'bottom',
  xAlign: 'center',
...
console.log(figure.fontManager.loadFont({ family: 'open sans', testString: 'latin' }));
console.log(figure.fontManager.loadFont({ family: 'open sans', testString: 'greek' }));
