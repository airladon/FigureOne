...
function makeSlides() {
  ...
  */
  ...
  slides.push({ time: '5:40', form: 'fullNames' });
  slides.push({ time: '5:50', form: 'keep' });
  slides.push({
    time: '5:50',
    form: 'finalPreK',
    transition: [
      [
        { goToForm: 'eqn', target: 'finalPreK', duration: 3, dissolveOutTime: 1, delay: 0 },
        { scenario: 'circ', target: 'circQ1Values', duration: 3, delay: 1 },
      ],
    ],
  });
