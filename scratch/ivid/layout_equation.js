  ...
  figure.add({
    ...
    options: {
      elements: {
        ...
        theta5: { text: '\u03b8', color: color1 },
        theta6: { text: '\u03b8', color: color1 },
        theta7: { text: '\u03b8', color: color1 },
        theta8: { text: '\u03b8', color: color1 },
        theta9: { text: '\u03b8', color: color1 },
        theta10: { text: '\u03b8', color: color1 },
        theta11: { text: '\u03b8', color: color1 },
        theta12: { text: '\u03b8', color: color1 },
        dotDotDot: '...',
        ...
        opposite_2: { color: color2 },
        opposite_3: { color: color2 },
        ...
        adjacent_2: { color: color2 },
        adjacent_3: { color: color2 },
      ...
      phrases: {
        ...
        hypOnOpp: { frac: ['hypotenuse_3', 'v4', 'opposite_2'] },
        hypOnAdj: { frac: ['hypotenuse_4', 'v5', 'adjacent_2'] },
