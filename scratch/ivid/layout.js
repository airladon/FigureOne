...
function makeLayout() {
  ...
  line.subscriptions.add('setTransform', () => {
    ...
    tanLabel.setPosition([radius + 0.03, i.y / 2]);
    sinLabel.setPosition([x < radius / 3 ? x + 0.1 : x - 0.1, Math.max(0.06, y / 2)]);
...
// figure.debugShowTouchBorders(figure.getElement('circle.angle').getAllElements())