...
var GeneralFunctionMap = /*#__PURE__*/function () {
  ...
  _createClass(GeneralFunctionMap, [{
    ...
    value: function exec(idOrFn) {
      ...
      throw new Error("".concat(idOrFn, " needs to be a function or a string"));
    }
  }, {
    key: "execOnMaps",
    value: function execOnMaps(idOrFn, mapsIn) {
      ...
      if (typeof idOrFn === 'string') {
        ...
        throw new Error("FunctionMap Error: '".concat(idOrFn, "' does not exist in map"));
      }
      ...
      throw new Error("FunctionMap Error: '".concat(idOrFn, "' needs to be a function or a string")); // return null;
    }
  }]);
...
var FunctionMap = /*#__PURE__*/function (_GeneralFunctionMap2) {
  ...
  _createClass(FunctionMap, [{
    ...
    key: "add",
    value: function add(id, fn) {
      return _get(_getPrototypeOf(FunctionMap.prototype), "add", this).call(this, id, fn);
    }
  }]);
...
var UniqueIdGenerator = /*#__PURE__*/function () {
  ...
  function UniqueIdGenerator() {
    var singleton = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
  ...
  _createClass(UniqueIdGenerator, [{
    ...
    key: "getId",
    value: function getId(seed) {
      if (this.seeds[seed] == null) {
        this.seeds[seed] = 0;
      }

      var id = "".concat(seed).concat(zeroPad(this.seeds[seed], 9));
      this.seeds[seed] += 1;
      return id;
    }
  }]);
...
function generateUniqueId() {
  ...
  return new UniqueIdGenerator().getId(seed); // const randomString = s => `${s}${Math.floor(Math.random() * 1000000)}`;
  // let seedToUse = seed;
...
var Subscription = /*#__PURE__*/function () {
  ...
  _createClass(Subscription, [{
    ...
    key: "publish",
    value: function publish(functionArgument) {
      var _this3 = this;
    ...
    key: "remove",
    value: function remove(subscirberId) {
      var id = "".concat(subscirberId);
...
/******/ });
//# sourceMappingURL=be5516fb82aecdd741d2.worker.js.map