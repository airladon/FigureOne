...
describe('Line', () => {
  describe('Creation', () => {
    ...
    test('Ends', () => {
      const l = new Line([0, 0, 0], [1, 1, 1], 1);
      expect(l.p1).toEqual(point(0, 0, 0));
  ...
  describe('Distance and Angles', () => {
    ...
    test('[1, 1, 1], [1, 2, 1]', () => {
      const l = new Line([1, 1, 1], [1, 2, 1]);
      expect(round(l.theta())).toEqual(round(Math.PI / 2));
      expect(round(l.phi())).toEqual(round(Math.PI / 2));
      expect(round(l.length())).toEqual(round(1));
    });
    test('[1, 1, 1], [0, 0, 0]', () => {
      const l = new Line([1, 0, 1], [0, 0, 0]);
  ...
  describe('hasPointOn', () => {
    ...
    test('one end [1, 1, 1], [2, 2, 2]', () => {
      const l = new Line([1, 1, 1], [2, 2, 2], 1);
      // Along Line
      expect(l.hasPointOn([1, 1, 1])).toBe(true);
      expect(l.hasPointOn([1.5, 1.5, 1.5])).toBe(true);
      expect(l.hasPointOn([2, 2, 2])).toBe(true);
    ...
    test('no ends [1, 1, 1], [2, 2, 2]', () => {
      const l = new Line([1, 1, 1], [2, 2, 2], 0);
      // Along Line
      expect(l.hasPointOn([1, 1, 1])).toBe(true);
      expect(l.hasPointOn([1.5, 1.5, 1.5])).toBe(true);
      expect(l.hasPointOn([2, 2, 2])).toBe(true);
  ...
  describe('isParallelTo', () => {
    test('[0, 0, 0], [1, 0, 0]', () => {
      const l = new Line([0, 0, 0], [1, 0, 0]);
      // Same Line
      expect(l.isParallelTo(new Line([0, 0, 0], [1, 0, 0]))).toBe(true);
      expect(l.reverse().isParallelTo(new Line([0, 0, 0], [1, 0, 0]))).toBe(true);
      // Collinear
      expect(l.isParallelTo(new Line([-10, 0, 0], [-11, 0, 0]))).toBe(true);
      // Parallel
      expect(l.isParallelTo(new Line([0, 1, 0], [1, 1, 0]))).toBe(true);
      expect(l.isParallelTo(new Line([0, 1, 1], [1, 1, 1]))).toBe(true);
      // Not parallel
      expect(l.isParallelTo(new Line([0, 1, 0], [1, 1, 1]))).toBe(false);
      expect(l.isParallelTo(new Line([0, 0, 0], [1, 0, 0.1]))).toBe(false);
    });
    test('[0, 0, 0], [1, 1, 1]', () => {
      const l = new Line([0, 0, 0], [1, 1, 1]);
      // Same Line
      expect(l.isParallelTo(new Line([0, 0, 0], [1, 1, 1]))).toBe(true);
      expect(l.reverse().isParallelTo(new Line([0, 0, 0], [1, 1, 1]))).toBe(true);
      // Collinear
      expect(l.isParallelTo(new Line([-10, -10, -10], [-11, -11, -11]))).toBe(true);
      // Parallel
      expect(l.isParallelTo(new Line([0, 1, 1], [1, 2, 2]))).toBe(true);
      // Not parallel
      expect(l.isParallelTo(new Line([0, 1, 0], [1, 1, 1]))).toBe(false);
      expect(l.isParallelTo(new Line([0, 0, 0], [1, 0, 0.1]))).toBe(false);
    });
  ...
  describe('Lines can be compared to other lines', () => {
    describe('Two Ends', () => {
      test('Line 1 is same as Line 2', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1]);
        const l2 = new Line([0, 0, 0], [1, 1, 1]);
      ...
      test('Collinear Lines, with some overlap', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1]);
        const l2 = new Line([-1, -1, -1], [0.5, 0.5, 0.5]);
      ...
      test('Line 1 is not same as Line 2', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1]);
        const l2 = new Line([0, 0, 0.01], [1, 1, 1]);
        expect(l1.isEqualTo(l2)).toBe(false);
      ...
      test('Line 1 is same as Line 2 with 0 precision', () => {
        const l1 = new Line([0, 0, 0.1], [1, 1, 1]);
        const l2 = new Line([0, 0, 0], [2, 2, 2]);
      ...
      test('Line 1 is same as Line 2 with 1 precision', () => {
        const l1 = new Line([0, 0, 0.01], [1, 1, 1]);
        const l2 = new Line([0, 0, 0], [2, 2, 2]);
    ...
    describe('1 end', () => {
      test('Line 1 is same as Line 2', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 1);
        const l2 = new Line([0, 0, 0], [1, 1, 1], 1);
        expect(l1.isEqualTo(l2)).toBe(true);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(true);
        expect(l1.hasLineWithin(l2)).toBe(true);
      ...
      test('Line 1 is same as Line 2 but with different definition', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 1);
        const l2 = new Line([0, 0, 0], [2, 2, 2], 1);
        expect(l1.isEqualTo(l2)).toBe(true);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(true);
        expect(l1.hasLineWithin(l2)).toBe(true);
      ...
      test('Line 1 infinite, Line 2 finite, same definition', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 1);
        const l2 = new Line([0, 0, 0], [1, 1, 1], 2);
        expect(l1.isEqualTo(l2)).toBe(false);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(false);
        expect(l1.hasLineWithin(l2)).toBe(true);
      ...
      test('Line 1 infinite, Line 2 infinite, different ends', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 1);
        const l2 = new Line([0.5, 0.5, 0.5], [1, 1, 1], 1);
        expect(l1.isEqualTo(l2)).toBe(false);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(false);
        expect(l1.hasLineWithin(l2)).toBe(true);
    ...
    describe('0 ends', () => {
      test('Line 1 is same as Line 2', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 0);
        const l2 = new Line([0, 0, 0], [1, 1, 1], 0);
        expect(l1.isEqualTo(l2)).toBe(true);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(true);
        expect(l1.hasLineWithin(l2)).toBe(true);
      ...
      test('Line 1 is same as Line 2 but with different definition', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 0);
        const l2 = new Line([0.5, 0.5, 0.5], [1, 1, 1], 0);
        expect(l1.isEqualTo(l2)).toBe(true);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(true);
        expect(l1.hasLineWithin(l2)).toBe(true);
      ...
      test('Line 1 is different to Line 2', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 0);
        const l2 = new Line([0, 1, 0], [1, 1, 1], 0);
        expect(l1.isEqualTo(l2)).toBe(false);
        expect(l1.isAlongLine(l2)).toBe(false);
        expect(l1.isWithinLine(l2)).toBe(false);
        expect(l1.hasLineWithin(l2)).toBe(false);
      ...
      test('Line 1 has 0 ends, line2 has 1 end and is within', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 0);
        const l2 = new Line([-10, -10, -10], [0, 0, 0], 1);
        expect(l1.isEqualTo(l2)).toBe(false);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(false);
        expect(l1.hasLineWithin(l2)).toBe(true);
      ...
      test('Line 1 has 0 ends, line2 has 2 end and is within', () => {
        const l1 = new Line([0, 0, 0], [1, 1, 1], 0);
        const l2 = new Line([-10, -10, -10], [0, 0, 0], 2);
        expect(l1.isEqualTo(l2)).toBe(false);
        expect(l1.isAlongLine(l2)).toBe(true);
        expect(l1.isWithinLine(l2)).toBe(false);
        expect(l1.hasLineWithin(l2)).toBe(true);
  ...
  describe('Distance between lines', () => {
    test('Two parallel lines', () => {
      ...
      const l2 = new Line(new Point(0, 0, 1), new Point(2, 0, 1));
      const d = l1.distanceToLine(l2);
      expect(round(d)).toBe(1);
    });
    test('Two parallel lines 2', () => {
      const l1 = new Line(new Point(1, 0, 1), new Point(2, 0, 2));
      const l2 = new Line(new Point(1, 1, 1), new Point(2, 1, 2));
      const d = l1.distanceToLine(l2);
      expect(round(d)).toBe(1);
    });
    test('Two skew lines 2', () => {
      const l1 = new Line(new Point(0, 0, 0), new Point(1, 0, 0));
      const l2 = new Line(new Point(0, -1, 1), new Point(0, 1, 1));
      const d = l1.distanceToLine(l2);
      expect(round(d)).toBe(1);
    });
    test('Intersecting Lines', () => {
      const l1 = new Line(new Point(0, 0, 0), new Point(1, 0, 0));
      const l2 = new Line(new Point(0, -1, 0), new Point(0, 1, 0));
      const d = l1.distanceToLine(l2);
  ...
  describe('Lines can intersect with other lines', () => {
    ...
    describe('Lines with two ends', () => {
      test('On line intersect 2D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0));
        const l2 = new Line(new Point(1, -1, 0), new Point(1, 1, 0));
        const res = l1.intersectsWith(l2);
      ...
      test('On line intersect non zero', () => {
        const l1 = new Line(new Point(1, 1, 1), new Point(-2, -2, -2));
        const l2 = new Line(new Point(-1, -1, 2), new Point(-1, -1, -2));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(-1, -1, -1));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('Off line intersect 2D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0));
        const l2 = new Line(new Point(1, -1, 0), new Point(1, -0.5, 0));
        const res = l1.intersectsWith(l2);
      ...
      test('Off line intersect 3D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 2, 2));
        const l2 = new Line(new Point(1, 1, 0), new Point(1, 1, 0.5));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 1, 1));
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(false);
      ...
      test('Parallel 2D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0));
        const l2 = new Line(new Point(0, 1, 0), new Point(2, 1, 0));
        const res = l1.intersectsWith(l2);
      ...
      test('Parallel 3D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 2, 2));
        const l2 = new Line(new Point(1, 0, 0), new Point(3, 2, 2));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toBe(undefined);
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(false);
      ...
      test('Collinear No Overlap 1', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0));
        const l2 = new Line(new Point(-2, 0, 0), new Point(-1, 0, 0));
        const res = l1.intersectsWith(l2);
      ...
      test('Collinear No Overlap 2', () => {
        const l1 = new Line(new Point(2, 0, 0), new Point(0, 0, 0));
        const l2 = new Line(new Point(-2, 0, 0), new Point(-1, 0, 0));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(-0.5, 0, 0));
        expect(res.onLines).toBe(false);
      ...
      test('Collinear No Overlap 3', () => {
        const l1 = new Line(new Point(2, 0, 0), new Point(0, 0, 0));
        const l2 = new Line(new Point(-1, 0, 0), new Point(-2, 0, 0));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(-0.5, 0, 0));
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(true);
      ...
      test('Collinear Ends Overlap', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0));
        const l2 = new Line(new Point(-2, 0, 0), new Point(0, 0, 0));
        const res = l1.intersectsWith(l2);
      ...
      test('Collinear Ends Overlap 2', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0));
        const l2 = new Line(new Point(2, 0, 0), new Point(3, 0, 0));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(0, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
      ...
      test('Collinear Ends Overlap 3', () => {
        const l1 = new Line(new Point(2, 0, 0), new Point(0, 0, 0));
        const l2 = new Line(new Point(0, 0, 0), new Point(-2, 0, 0));
        const res = l1.intersectsWith(l2);
      ...
      test('Collinear Full Overlap', () => {
        const l1 = new Line(new Point(2, 0, 0), new Point(0, 0, 0));
        const l2 = new Line(new Point(1, 0, 0), new Point(0.5, 0, 0));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(2, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
    ...
    describe('Lines with 2 and 1 ends', () => {
      test('On line intersect 2D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 2);
        const l2 = new Line(new Point(1, -1, 0), new Point(1, -0.5, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('On line intersect 2D Reverse', () => {
        const l2 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 2);
        const l1 = new Line(new Point(1, -1, 0), new Point(1, -0.5, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('On line intersect 3D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 2, 2), 2);
        const l2 = new Line(new Point(1, 0, 0), new Point(1, 0.5, 0.5), 1);
        const res = l1.intersectsWith(l2);
      ...
      test('On line intersect 3D Reverse', () => {
        const l2 = new Line(new Point(0, 0, 0), new Point(2, 2, 2), 2);
        const l1 = new Line(new Point(1, 0, 0), new Point(1, 0.5, 0.5), 1);
        const res = l1.intersectsWith(l2);
        expect(round(res.intersect)).toEqual(new Point(1, 1, 1));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('Off line intersect 2D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 2);
        const l2 = new Line(new Point(1, 1, 0), new Point(1, 1.5, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 0, 0));
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(false);
      ...
      test('Off line intersect 3D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 2, 2), 2);
        const l2 = new Line(new Point(1, 0.5, 0.5), new Point(1, 0, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(round(res.intersect)).toEqual(new Point(1, 1, 1));
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(false);
      ...
      test('Collinear No Overlap 1', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 1);
        const l2 = new Line(new Point(-2, 0, 0), new Point(-1, 0, 0));
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(-0.5, 0, 0));
        expect(res.onLines).toBe(false);
      ...
      test('Collinear No Overlap 2', () => {
        const l1 = new Line(new Point(2, 0, 0), new Point(0, 0, 0));
        const l2 = new Line(new Point(-1, 0, 0), new Point(-2, 0, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(-0.5, 0, 0));
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(true);
      ...
      test('Collinear Ends Overlap 2', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0));
        const l2 = new Line(new Point(2, 0, 0), new Point(3, 0, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(0, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
    ...
    describe('Lines 1 ends', () => {
      ...
      test('On line intersect 2D Reverse', () => {
        const l2 = new Line(new Point(0, 0, 0), new Point(0.5, 0, 0), 1);
        const l1 = new Line(new Point(1, -1, 0), new Point(1, -0.5, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 0, 0));
        expect(res.onLines).toBe(true);
      ...
      test('On line intersect 3D', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 2, 2), 1);
        const l2 = new Line(new Point(1, 0, 0), new Point(1, 0.5, 0.5), 1);
        const res = l1.intersectsWith(l2);
        expect(round(res.intersect)).toEqual(new Point(1, 1, 1));
        expect(res.onLines).toBe(true);
      ...
      test('On line intersect 3D Reverse', () => {
        const l2 = new Line(new Point(0, 0, 0), new Point(0.1, 0.1, 0.1), 1);
        const l1 = new Line(new Point(1, 0, 0), new Point(1, 0.5, 0.5), 1);
        const res = l1.intersectsWith(l2);
        expect(round(res.intersect)).toEqual(new Point(1, 1, 1));
        expect(res.onLines).toBe(true);
      ...
      test('Collinear Ends Overlap', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 1);
        const l2 = new Line(new Point(0, 0, 0), new Point(-2, 0, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(0, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
      ...
      test('Collinear Ends Overlap 2', () => {
        const l1 = new Line(new Point(2, 0, 0), new Point(0, 0, 0), 1);
        const l2 = new Line(new Point(2, 0, 0), new Point(3, 0, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(2, 0, 0));
        expect(res.onLines).toBe(true);
      ...
      test('Collinear Partial Overlap 2', () => {
        const l1 = new Line(new Point(2, 0, 0), new Point(0, 0, 0), 1);
        const l2 = new Line(new Point(1, 0, 0), new Point(1.5, 0, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(2, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
    ...
    describe('Lines with 0, 1 and 2 ends', () => {
      test('On line intersect 2D, Ends: 0 & 2', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(1, -1, 0), new Point(1, 0.5, 0), 2);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('On line intersect 2D, Ends: 0 & 0', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(1, -1, 0), new Point(1, -0.5, 0), 0);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('On line intersect 2D, Ends: 0 & 0 - 2', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(1, -1, 0), new Point(1, -1.5, 0), 0);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(1, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('Parallel: 0 & 0', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(1, 0, 1), new Point(2, 0, 1), 0);
        const res = l1.intersectsWith(l2);
      ...
      test('Skew: 0 & 0', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(1, 0, 1), new Point(2, 1, 1), 0);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(undefined);
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(false);
      ...
      test('On line intersect 3D, Ends: 0 & 2', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 2, 2), 0);
        const l2 = new Line(new Point(1, 0, 0), new Point(1, 1.5, 1.5), 2);
        const res = l1.intersectsWith(l2);
        expect(round(res.intersect)).toEqual(new Point(1, 1, 1));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(false);
      ...
      test('Off line intersect 3D, Ends: 0 & 2', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 2, 2), 0);
        const l2 = new Line(new Point(1, 0, 0), new Point(1, 0.5, 0.5), 2);
        const res = l1.intersectsWith(l2);
        expect(round(res.intersect)).toEqual(new Point(1, 1, 1));
        expect(res.onLines).toBe(false);
        expect(res.collinear).toBe(false);
      ...
      test('Collinear Full Overlap, Ends: 0 & 2', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(4, 0, 0), new Point(5, 0, 0), 2);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(0, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
      ...
      test('Collinear Full Overlap, Ends: 0 & 1', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(4, 0, 0), new Point(5, 0, 0), 1);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(0, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
      ...
      test('Collinear Full Overlap, Ends: 0 & 0', () => {
        const l1 = new Line(new Point(0, 0, 0), new Point(2, 0, 0), 0);
        const l2 = new Line(new Point(4, 0, 0), new Point(5, 0, 0), 0);
        const res = l1.intersectsWith(l2);
        expect(res.intersect).toEqual(new Point(0, 0, 0));
        expect(res.onLines).toBe(true);
        expect(res.collinear).toBe(true);
  ...
  describe('offset', () => {
    test('direction and mag - actually perp', () => {
      ...
      expect(o).toEqual(new Line([0, 2, 0], [1, 2, 0]));
    });
    ...
    test('direction only', () => {
      ...
      expect(o.round())
        .toEqual(new Line([0, 2 * Math.sqrt(2), 0], [1, 2 * Math.sqrt(2), 0]).round());
    });
  });
