...
describe('Axis', () => {
  ...
  test('Default', () => {
    ...
    expect(axis.props.majorTicks.length).toBe(0.05);
    ...
    expect(axis.props.majorGrid.length).toBe(1);
    ...
    expect(axis.props.minorTicks.length).toBe(0.02);
    ...
    expect(axis.props.minorGrid.length).toBe(1);
