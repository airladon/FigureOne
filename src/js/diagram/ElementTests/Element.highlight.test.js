...
describe('Highlight', () => {
  ...
  describe('Collections', () => {
    ...
    test('Entire Collection - Not Dim', () => {
    ...
    test('Parts of the Collection', () => {
      ...
      collection.highlight(['s3', 'squares.s1']);
