...
describe('Polyline', () => {
  ...
  beforeEach(() => {
    ...
    corneredRectLineInside = [
      -0.9, -0.159, -0.659, -0.4, -1, -0.2, -1, -0.2,
      -0.659, -0.4, -0.7, -0.5, -0.659, -0.4, 0.659, -0.4,
      -0.7, -0.5, -0.7, -0.5, 0.659, -0.4, 0.7, -0.5,
      0.659, -0.4, 0.9, -0.159, 0.7, -0.5, 0.7, -0.5,
      0.9, -0.159, 1, -0.2, 0.9, -0.159, 0.9, 0.159,
      1, -0.2, 1, -0.2, 0.9, 0.159, 1, 0.2,
      0.9, 0.159, 0.659, 0.4, 1, 0.2, 1, 0.2,
      0.659, 0.4, 0.7, 0.5, 0.659, 0.4, -0.659, 0.4,
      0.7, 0.5, 0.7, 0.5, -0.659, 0.4, -0.7, 0.5,
      -0.659, 0.4, -0.9, 0.159, -0.7, 0.5, -0.7, 0.5,
  ...
  describe('Filled', () => {
    ...
    test('Touch border buffer', () => {
      ...
      expect(round(r.getBorder('draw', 'touchBorder'), 3)).toEqual([getPoints([
        [-1.1, 0.241], [-1.1, -0.241], [-0.741, -0.6], [0.741, -0.6],
        [1.1, -0.241], [1.1, 0.241], [0.741, 0.6],
        [-0.741, 0.6],
      ])]);
      expect(r.getBorder('draw', 'holeBorder')).toEqual([[]]);
    });
