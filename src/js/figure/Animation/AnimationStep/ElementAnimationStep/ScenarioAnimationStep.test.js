...
describe('Figure Recorder', () => {
  ...
  test('Position, Rotation, Scale, Color, isShown with Start', () => {
    ...
    expect(a.getScale().round(3)).toEqual(new Point(3, 3, 1));
    ...
    expect(a.getScale().round(3)).toEqual(new Point(2.5, 2.5, 1));
  ...
  test('Velocity different durations', () => {
    ...
    expect(a.getScale().round(3)).toEqual(new Point(1.1, 1.1, 1));
