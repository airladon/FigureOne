...
export default class EquationSymbols {
  ...
  get(
    ...
    if (name === 'vinculum') {
      return this.vinculum(options as any);
    }
    if (name === 'strike') {
      return this.strike(options as any);
    }
    if (name === 'bracket') {
      return this.bracket(options as any);
    }
    if (name === 'squareBracket') {
      return this.squareBracket(options as any);
    }
    if (name === 'brace') {
      return this.brace(options as any);
    }
    if (name === 'bar') {
      return this.bar(options as any);
    }
    if (name === 'tBox') {
      return this.touchBox(options as any);
    }
    if (name === 'box') {
      return this.box(options as any);
    }
    if (name === 'division') {
      return this.division(options as any);
    }
    if (name === 'angleBracket') {
      return this.angleBracket(options as any);
    }
    if (name === 'radical') {
      return this.radical(options as any);
    }
    if (name === 'sum') {
      return this.sum(options as any);
    }
    if (name === 'prod') {
      return this.product(options as any);
    }
    if (name === 'int') {
      return this.integral(options as any);
    }
    if (name === 'arrow') {
      return this.arrow(options as any);
    }
    if (name === 'line') {
      return this.line(options as any);
    }
    return null;
  }
  ...
  box(optionsIn: EQN_BoxSymbol) {
    ...
    const optionsToUse = joinObjects<any>(defaultOptions, optionsIn);
    return (new Box(
      this.shapes.webgl[0],
      optionsToUse.color,
      new Transform().scale(1, 1).translate(0, 0),
  ...
  radical(optionsIn: EQN_RadicalSymbol) {
    const defaultOptions: {
      ...
      maxStartWidth: number | null | undefined;
      maxStartHeight: number | null | undefined;
      staticSize: Point | [number, number] | null | undefined;
      draw: 'static' | 'dynamic';
      staticHeight?: number | 'first';
      staticWidth?: number | 'first';
    } = {
