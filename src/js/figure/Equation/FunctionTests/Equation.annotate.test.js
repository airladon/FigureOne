...
describe('Equation Functions - Ann', () => {
  ...
  test('Simple Left', () => {
    ...
    figure.setFirstTransform();
    const a = eqn._a.getBoundingRect('local');
    const left = eqn._left.getBoundingRect('local');
    const right = eqn._right.getBoundingRect('local');
  ...
  test('Simple Encompass', () => {
    ...
    figure.setFirstTransform();
    const a = eqn._a.getBoundingRect('local');
    const box = eqn._box.getBoundingRect('local');
  ...
  test('Simple Static Encompass', () => {
    ...
    figure.setFirstTransform();
    const a = eqn._a.getBoundingRect('local');
    const box = eqn._boxStatic.getBoundingRect('local');
  ...
  describe('Parameter Steps', () => {
    ...
    test('space', () => {
      ...
      const newBox = eqn._box1.getBoundingRect('local');
